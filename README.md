...
**KFD**, like [ActiveBreach](https://github.com/8damon/ActiveBreach-Engine) is a ``syscall`` execution framework. This is a redux specialized for operating in heavily sandboxed/EDR-monitored environments.
